    ...
    <body>
      ...
      <style type="text/css">
       ...
       @forelse($results as $result)
        <tr>
        <td align="left"><span>{!! $result['const_no'] !!} - {!! $result['const_name'] !!}</span></td> 
         <td align="left">{{$result['total_ps'] }}</td>
         <td align="left">{{$result['total_tables'] }}</td>
         <td align="left">{{$result['total_assigned'] }}</td>
         <td align="left">{{$result['total_rounds'] }}</td>
        </tr>
         @empty
                <tr>

...
<section>
  ...
  <div class="card text-left" style="width:100%; margin:0 auto;">
      ...
      <div class=" row">
            <div class="col"><h4> Result Summary</h4></div> 
              <div class="col"><p class="mb-0 text-right"><b>Name:</b> <span class="badge badge-info">{{$user_data->placename}}</span> &nbsp;&nbsp; <b></b> 
              <span class="badge badge-info"></span>&nbsp;&nbsp; <a href="{{url('/eci/counting/BoothCountingSummaryReport/pdf')}}" class="btn btn-info" role="button">PDF Dwonload</a> &nbsp;&nbsp;
              <!--<a href="{{url('/eci/counting/BoothCountingSummaryReport/excel')}}" class="btn btn-info" role="button">Export Excel</a> &nbsp;&nbsp; -->
 ...
 <div class="card-body">  
    ...
    <table class="table table-striped table-bordered table-hover" style="width:100%">
         ...
         <tr>
          ...
          <th style="background-color: #d7d7d7; color: #000;">ACs Where Result Is Declared</th>
          <!--<th>Percentage</th> -->
        </tr>
        </thead>
        <tbody>

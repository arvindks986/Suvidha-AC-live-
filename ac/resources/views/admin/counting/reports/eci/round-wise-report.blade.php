...
<div class="btns-actn">
{{ Form::model('', ['action' => 'Admin\counting\BoothRoundWiseReportController@getCompleteResult', 'name'=>'pdfForm' ]) }}
...
function getResultECI(){ 
	...
	$.ajax({
			type: "POST",
			url: "<?php echo url('/'); ?>/eci/counting/boothget-all-result-eci", 
			data: {
				"_token": "{{ csrf_token() }}",
				"st_code": state,
				"ac": ac,
...
function getAcByStateAndPcId(sId){ 
   $('#showResult').hide();
	...
	$.ajax({
			type: "POST",
			url: "<?php echo url('/'); ?>/eci/counting/boothget-ac-by-state-and-pc-id-eci", 
			data: {
				"_token": "{{ csrf_token() }}",
				"st_code": sId
				},
...
function getCandidate(){
	...
	$.ajax({
			type: "POST",
			url: "<?php echo url('/'); ?>/eci/counting/boothget-condidate-details-eci-ac-wise", 
			data: {
				"_token": "{{ csrf_token() }}",
				"stateok": state,
				"ac": acC

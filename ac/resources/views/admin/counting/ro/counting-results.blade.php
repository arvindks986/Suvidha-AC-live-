 ...
 <section>
  ...
  <div class="card text-left" style="width:100%; margin:0 auto;">
                ...
                <div class=" row">
				 ...
				 <small>@if($counting_finalized==0) Your AC Not Finalize @endif</small></div> 
  ...
  <table   class="table table-striped table-bordered" style="width:100%">
      ...
      <tbody>
          ...
          <tr><td>{{$j}}</td> <td>{{$md->candidate_name}} <br>{{$md->candidate_hname}} 
            ...
            <form class="form-horizontal" id="election_form" method="POST"  action="{{url('/roac/counting/boothresults-declaration') }}" > 
            ...
            {{ csrf_field() }}    
              ...
              <div class="form-group float-right"> 
                ...
                @if($counting_finalized==1 && isset($winn_data) && $winn_data->status==0)
                
               <!--  <button type="button" class="btn btn-primary electrolpopup" data-toggle="modal" data-target="#myModal" data-stcode="{{$st_code }}" data-ac_no="{{$ac_no}}" data-tended_votes="{{$round_details->tended_votes }}">Add Tendered Votes</button> -->
               @if(isset($round_details) && $round_details->tended==1) 
                ...
                @endif 
                  ...
                  <!-- <span class="report-btn" id="export-pdf-btn"><a class="btn btn-primary" href="{{$url}}/roac/form-21-report-pdf" download="download" title="Download PDF">Download Form 20</a></span> -->
                  <a class="btn btn-primary" href="{{url('/roac/form-21-report-pdf')}}" title="Download PDF">Download Form 21 E</a>
...
<div class="modal" id="myModal">
 ...
 <form class="form-horizontal" method="POST" action="{{url('roac/counting/booth-tenders-votes')}}" id="election_form">
      <!-- Modal body -->
...
$("#election_form #submit_form").click(function(){
   ...
   $(document).ready(function(e){
    $('#preview_submit').click(function(e){
      $.ajax({
        url: "{!! url('/roac/counting/bothverify_winner_by_name') !!}",
        type: 'POST',

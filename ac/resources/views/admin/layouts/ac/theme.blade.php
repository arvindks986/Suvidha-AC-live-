...
<!-- JavaScript files-->
  ...
  <!--  <script src="{{ asset('theme/js/bootstrap-datepicker.js') }}"  type="text/JavaScript"></script>  -->
    ...
    <script type="text/javascript" src="{{ asset('theme/js/slider-menu.jquery.js') }}"></script>
...
<script>$(document).ready(function() {
    $('#example').DataTable();
    $('#list-table,#list-table1,#list-table2,#list-table3').DataTable();
...
<script type="text/javascript">
 ...
 <script>  window.fwSettings={  'widget_id':44000000524  };  !function(){if("function"!=typeof window.FreshworksWidget){var n=function(){n.q.push(arguments)};n.q=[],window.FreshworksWidget=n}}() </script> <script type='text/javascript' src='https://widget.freshworks.com/widgets/44000000524.js' async defer></script>

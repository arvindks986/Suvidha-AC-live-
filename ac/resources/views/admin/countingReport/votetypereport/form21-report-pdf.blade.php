...
if($total_validpol >0){?>
         <!--HEADER STARTS HERE-->
        	...
        	<tr> <th style="width:100%; font-size:20px;margin:5px 0;" align="center" >Return of Election</th></tr>
                <tr><td style="line-height: 32px;font-size: 18px;">Election to the Legislative Assembly of <b><u><?php if(isset($state)){ echo $state;}?></u></b>  from <b><u><?php if(isset($acname)){?>{{$acname}}<?php }?></u></b> Assembly constituency.</td></tr>
              </thead>
            </table>

    ...
    <div class="row">
      <div class="col-md-4 pb-3">
        <div class="card income text-center mt-3">
          <div class="d-flex justify-content-between">
            <div>
              <strong class="text-primary"><a href="{{url('acdeo/pwd/wheel-chair')}}">Wheel Chair Requests</a></strong>
            </div>
      ...
      <div class="col-md-4 pb-3">
        <div class="card income text-center mt-3">
          <div class="d-flex justify-content-between">
            <div>
              <strong class="text-primary"><a href="{{url('acdeo/pwd/pick-drop')}}">Pick & Drop Requests</a></strong>
            </div>
      ...
      <div class="col-md-4 pb-3">
        <div class="card income text-center mt-3">
          <div class="d-flex justify-content-between">
            <div>
              <strong class="text-primary"><a href="{{url('acdeo/pwd/volunteer')}}">Volunteer Requests</a></strong>
            </div>

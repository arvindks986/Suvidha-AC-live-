...
@section('bradcome', 'Pwd Pick & Drop Requests')
@section('content')
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="data_table_table" class="table table-striped table-bordered" style="width:100%">
                            <thead>
                                ...
                                <tr>
                                    <th colspan="{{(($user_data['role_id'] != '19') ? '13' : '11')}}" class="text-center">Pwd Pick & Drop Requests</th>
                                </tr>
                                <tr>
                                    <th>S.no</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{url('roac/pwd/update-remarks')}}" method="post">
                                            ...
                                            <input type="hidden" name="for" value="PickDrop">
                                            {{@csrf_field()}}

...
@section('bradcome', 'Physical Verification Report')
@section('content')
                        ...
                        <table id="list-table" class="table table-striped table-bordered table-hover"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="3" class="text-center">PHYSICAL VERIFICATION COUNT</th>
                                </tr>
                                <tr>
                                    <th>S.No</th>
                                    <th>STATE NAME</th>
                                    <th>PHYSICAL VERIFICATION PENDING</th>
                                    <th>PHYSICAL VERIFICATION DONE</th>
                                    <th>TOTAL</th>
                                </tr>
                            </thead>
                            <tbody>
                              @if(count($results)>0)
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ $item['pending_physical_verification_url'] }}">{{$item['pending_physical_verification']}}</a></td>
                                    <td><a href="{{ $item['done_physical_verification_url'] }}">{{$item['done_physical_verification']}}</a></td>

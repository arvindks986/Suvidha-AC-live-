	...
	<table class="table-strip" style="width: 100%;" border="1" align="center">
		<thead>
			...
			@if(is_null(request()->get('appointment')))
					...
					@else
					<tr>
						<th colspan="4">Total Appointment</th>
						<th colspan="4">Appointment Given</th>
						<th colspan="4">Appointment Pending</th>
					</tr>
					<tr>
						<th colspan="4">{{$application_appointment_count['total_appointment']}}</th>
						<th colspan="4">{{$application_appointment_count['appointment_done']}}</th>

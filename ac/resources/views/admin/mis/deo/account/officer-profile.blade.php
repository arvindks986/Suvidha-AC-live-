...
<section>	 
	 <form enctype="multipart/form-data" id="election_form" method="POST"  action="{{url('acdeo/mis/updateuser') }}" >
	  {{ csrf_field() }}
  <div class="container">
  <div class="row">
...
@endif
    ...
    <div class="card-body">
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col">
                   <input id="address1" type="text" class="form-control" name="address1" value="{{ $getofficerdetails[0]->ro_address_l1 }}">
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col">
                   <input id="address2" type="text" class="form-control" name="address2" value="{{ $getofficerdetails[0]->ro_address_l2 }}">
                 ...
                 <div class="line"></div>
                 <div class="form-group row">
                  <label class="col-sm-3">Address Zip Code<sup>*</sup></label>
                  <div class="col">
                   <input id="zip" type="text" class="form-control" name="zip" maxlength="6" value="{{ $getofficerdetails[0]->ro_address_pin_code }}">
                   @if ($errors->has('zip'))
                   <span class="help-block" style="color:red;">

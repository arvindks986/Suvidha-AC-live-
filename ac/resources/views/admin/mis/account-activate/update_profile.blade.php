...
<body>
 <main>
  ...
  <span style="margin: auto;">
   <img style="max-width: 300px;" src="{{ asset('theme/img/logo/eci-logo.png') }}" alt="" /><p>Election Commission of India</p> </span></figure> </div>
    <div class="col-md-6">
    <div class="login-right">
	  ...
	  <div class="alert alert-warning" id="otpinfomsgerr" style="display:none"> </div>
		...
		<div class="updateprofile" id="profileinfo" style="display:none; ">
			...
			<div class="form-group">
			     <input type="hidden" name="createpassurl" id="createpassurl" value="<?php echo $url.'/garudapp/login'; ?>">
...
$(document).ready(function(){
	...
	$("#updateprofile").click(function(){
		...
		{
		 if($("#psw").val() !='' && $("#pswcnf").val() !=''){
			  var password_confirmation = SHA256($("#pswcnf").val());
			  password = SHA256($("#psw").val());
			  password_confirmation = SHA256($("#pswcnf").val());
			  $("#psw").val(password);
			  $("#pswcnf").val(password_confirmation);
		  }

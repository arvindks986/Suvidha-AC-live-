	...
	<div class="col-sm-6 col-6">
	  <div class="pl-3 pr-3">
		<div class="form-group row">
			<label for="" class="col-6 col-form-label">Name of Election</label>
			<div class="col-6">
		...
		<div class="form-group row">
			<label for="" class="col-6 col-form-label">Election Year</label>
			<div class="col-6">
		...
		<div class="form-group row">
			<label for="" class="col-6 col-form-label">Name of the state/UT</label>
			<div class="col-6">
		...
		<div class="form-group row">
			<label for="applicant_designation" class="col-6 col-form-label">Designation</label>
			<div class="col-6">
		...
		<div class="form-group row">
			<label for="applicant_address" class="col-6 col-form-label">Address</label>
			<div class="col-6">
...
<div class="col-sm-6 col-6">
	  <div class="pl-3 pr-3">
		...
		<div class="form-group row">
			<label for="exgratia_pending" class="col-6 col-form-label">Ex-gratia Status</label>
			<div class="col-6">
	...
	<div class="text-center pt-3 pb-3">
	 <a href="{{Common::generate_url('mis/list-exgratia')}}"><button class="btn btn-default" type="button">Back</button></a>
   </div>	

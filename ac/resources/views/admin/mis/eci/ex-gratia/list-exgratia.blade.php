	  ...
	  <div class="card card-shadow mt-4">
          ...
          <div class=" row">
            ...
            <p class="mb-0 text-right">
              <!--<a href="{{Common::generate_url('mis/exgratia-pdf')}}" target="_blank" class="btn btn-primary">Download PDF</a>-->
                        ...
                        <div id="apld" class="tab-pane active">
							...
							<table class="table table-borderless mediaTable">
							 <tbody>
							  ...
							  $dist=getdistrictbydistrictno($listdata->st_code,$listdata->dist_no); 
							  ...
							  @endphp
								...
								<tr>
								  ...
								  <div class="tdBox">
								    District:
									<h5>@if(!empty($dist)){{$dist->DIST_NAME}}@endif</h5>  
								  </div>
								  <div class="tdBox">
								...
								<td class="pr-0">
							   	...
							   	<td>
								 <a href="{{url('seczonal/mis/edit-exgratia/'.encrypt($listdata->id))}}">View Details</a>   
								</td>
							   </tr> 

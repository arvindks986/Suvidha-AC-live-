...
?>
	...
	<main role="main" class="inner cover mb-3">
		<section>	 
			<form enctype="multipart/form-data" id="election_form" method="POST"  action="{{url('acceo/mis/updateuser') }}" >
				{{ csrf_field() }}
				<div class="container">
					<div class="row">
       ...
       @if(Session::has('success_mes'))
          ...
          @endif
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col">
                   <input id="zip" type="text" class="form-control" name="zip" maxlength="6" value="{{ $getofficerdetails->ro_address_pin_code }}">
                   @if ($errors->first('zip'))
                   <span class="help-block" style="color:red;">

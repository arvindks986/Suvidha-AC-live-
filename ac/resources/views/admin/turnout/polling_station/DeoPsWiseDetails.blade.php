...
<div class="container-fluid">
  <div class="row"><div class="col-md-12">Only Electors Data Need To Be Updated Before Poll.</div></div>
  <div class="row">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form class="form-horizontal" method="POST" action="{{url('acdeo/turnout/DeoPsWiseDetailsUpdate')}}" id="CeoPsWiseDetailsUpdate">

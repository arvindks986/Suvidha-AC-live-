  ...
  <div class="row text-center mb-3">
    <div class="col">
      ...
      <span class="">
        ...
        <br />
        <span type="text" style="color: #28a745;  text-transform: uppercase;  letter-spacing: 3px;" class=" ">Voter Turn Out</span>
      </span>
      @endif
    </div>
  </div>
          ...
          <div class="table-responsive">
            ...
            <table id="acViewBody" class="table table-striped table-bordered" style="width:100%">
              <thead>
                ...
                <tr>
                  <th colspan="11" class="text-center">{!! $heading_title_with_all !!}</th>
                </tr>
                <tr>

  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <form action="{{$action}}" method="post" class="mb-0">
        <div class="card" style="min-height:200px;margin-bottom: 0px;">
      ...
      $(document).ready(function(e){
        $('#get_otp').click(function(){
          $.ajax({
            url: "{!! $action !!}",
            type: 'POST',
            data: '_token=<?php echo csrf_token() ?>&code=<?php echo $code ?>&mobile='+$('#mobile').val(),
            dataType: 'json', 
            beforeSend: function() {
        ...
        $('#verify_otp').click(function(){
          $.ajax({
            ...
            type: 'POST',
            data: '_token=<?php echo csrf_token() ?>&code=<?php echo $code ?>&mobile='+$('#mobile').val()+'&otp='+$('#otp').val(),
            dataType: 'json', 
            beforeSend: function() {
              $('.error_message').remove();

...
<table style="width:100%; text-align:center;" border="1" align="center" cellpadding="5" cellspacing="0" >
  <thead> <tr> 
       ...
       <th align="center">Symbol  Name in English</th> 
       <!-- <th align="center">Symbol  Name in Hindi</th> -->
       <th align="center">Symbol  Name in vernacular</th>
    </tr>  
   </thead>
  <tbody>  <?php $i=0; ?>
  @foreach ($records as $key => $item)
    ...
    <tr>
    <td>{{$i}}</td>
    <td>@if($item->symbol_name!=''){{$item->symbol_name }} @endif</td>
    <!-- <td><span style="font-family:freeserif;">@if($item->symbol_name!=''){{$item->symbol_hname }}@endif</span></td> -->
    <td><span style="font-family:{{$fonts}};">@if($item->symbol_name!=''){{$item->symbol_vname }}@endif</span></td>
    </tr>
  @endforeach
  </tbody>  
  </table> 

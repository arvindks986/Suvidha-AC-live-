            ...
            <div class="col pl-0">
                ...
                <div class="card income">
                    <div class="card-body">
                        ...
                        <div class="text-success text-center"><b>Police Station</b> &nbsp; <div
                    ...
                    <div class="card">
                        ...
                        <div class="card-body getpermission">
                            ...
                            <form class="form-horizontal" method="POST"
                                action="{{url('/roac/permission/addauthoritydata')}}">
                                {{csrf_field()}}
                                <div class="form-group row">
                                    <label class="col-sm-4 form-control-label">Incharge Mobile No <sup>*</sup></label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" placeholder="Enter Mobile Number"
                                            name="mb" value="{{old('mb')}}" id="mobileno" required pattern="[6789][0-9]{9}">
                                        <span class="text-danger">{{ $errors->error->first('mb') }}</span>
                                        <span id="messege-text" style="color: blueviolet;font-size: 14px; line-height: 2px;"></span>
                                    </div>
                                </div>
      ...
      var csrf_token = $('meta[name="csrf-token"]').attr('content');
       let el_down = document.getElementById("messege-text");
        $.ajax({
            ...
            method: 'POST',
            url: APP_URL + "/roac/permission/getmobile",
            ...
            success:function(data)
            {
               ...
               if(data.status){
                     ...
                     el_down.innerHTML = "Nodal has been created with this mobile number,"; 
                      el_down.innerHTML += "<a href='javascript:void(0);' onclick='window.location.reload();'> Click here </a> to use another mobile number.<br />"
                      el_down.innerHTML += "If you want to use this nodal then click on the 'ADD' button given below.";  

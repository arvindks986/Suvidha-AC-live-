...
<section class="statistics">
        <div class="container-fluid mt-5 mb-5">
		  ...
		  <a type="button" href="{{url('/roac/permission/viewagent')}}" class="btn btn-sm btn-outline-primary">View</a>
                  <a type="button" href="{{url('/roac/permission/agentCreation')}}" class="btn btn-sm btn-primary">Add</a>
				  </div></div>
              </div>
            </div>
                    ...
                    <div class="sidebar__inner">
                        <div class="card"><!--  style="max-width:700px; margin:0 auto;" -->
                            ...
                            <div class="card-body getpermission">
                                ...
                                <form class="form-horizontal" method="POST" action="{{url('/roac/permission/editagent')}}">
                                    {{csrf_field()}}

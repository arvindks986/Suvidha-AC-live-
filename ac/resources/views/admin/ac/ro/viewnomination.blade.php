                  ...
                  <form class="form-horizontal">
                    <div class="form-group row">
                      <label class="col-sm-3">Name</label>
                       <div class="col">English <br>{{$persoanlDetails->cand_name}}  </div>  
					   <div class="col">Hindi <br> {{$persoanlDetails->cand_hname}} </div>
					   <div class="col">Vernacular <br>{{$persoanlDetails->cand_vname}} </div>
                    </div>
                    <div class="line"></div>
				<div class="form-group row">
					...
					<div class="line"></div>
					<div class="form-group row">
                      <label class="col-sm-3">Father's / Mother's Name / Husband's Name </label>
                      <div class="col">English <br>{{$persoanlDetails->candidate_father_name}}  </div>  
					   <div class="col">Hindi <br> {{$persoanlDetails->cand_fhname}} </div>
					   <div class="col">Vernacular <br>{{$persoanlDetails->cand_fvname}} </div>
					...
					<div class="line"></div> 
					 <div class="form-group row">
                      <label class="col-sm-3">Address Vernacular</label>
                      <div class="col"> {{$persoanlDetails->candidate_residence_addressv}} </div>
                      
                    </div>
				  <div class="line"></div>
				  <div class="form-group row">
					<div class="col-sm-3"><label for="statename">State Name </label></div>
					<div class="col">{{$st->ST_NAME}} </div>
						 
					<div class="col-sm-3"><label for="statename">District </label></div>
					<div class="col">{{$dist->DIST_NAME}} </div>
				  ...
				  <div class="form-group row">
					...
					<div class="form-group row">
					<div class="col-sm-3"><label for="statename">Candidate have Shown Criminal antecedents </label></div>
				 ...
				 <div class="form-group row float-right">       
					  <div class="col">
					  	<button type="button" id="Cancel" class="btn btn-primary" onclick="location.href ='{{$url}}/roac/listnomination';">Back</button>

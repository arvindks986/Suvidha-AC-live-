  ...
  <div class="container-fluid">
    ...
    <div class="form-group col-md-6">
         ...
         <div class="form-group col-md-6"> <label>Constituency </label> 
            ...
            @if(isset($list_const))
            @foreach($list_const as $list_const)
                <option value="{{$list_const['ac_no']}}" selected="{{$list_const['ac_no']}}" >{{$list_const['ac_name']}}</option>   
            @endforeach
            @endif  
            </select>
          </div>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col">
        ...
        <span id="timeRange">{!! $heading_title !!}</span> -<span id="caseType"> {{$user_data->placename}}</span>
      </h5>
      </div>
    </div>
  </div>

                ...
                <div class="col">
                    <div class="tab-content tabular-pane" id="pills-tabContent">
                            ...
                            <table id="list-table" class="table table-striped table-bordered table-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-outline-danger btn-block" style=" text-align: left;" href="{{url('/acdeo/getpermissiondetails')}}/{{encrypt($data->permission_id)}}">
                                                @if(!empty($data->reference_id))
                                                {{$data->reference_id}}<i class="fa fa-edit float-right font-size01"></i>
                                                @else
                                                {{$data->permission_id}}<i class="fa fa-edit float-right font-size01"></i>
                                                @endif
                                            </a>
                                        </td>
                        ...
                        <div class="tab-pane fade bgactive" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                            <table id="list-table1" class="table table-striped table-bordered table-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a class="btn btn-outline-danger btn-block" style=" text-align: left;" href="{{url('/acdeo/getpermissiondetails')}}/{{encrypt($rdata->permission_id)}}">
                                               @if(!empty($rdata->reference_id))
                                                {{$rdata->reference_id}}<i class="fa fa-edit float-right font-size01"></i>
                                                @else
                                                {{$rdata->permission_id}}<i class="fa fa-edit float-right font-size01"></i>
                                                @endif
                                            </a>
                                        </td>
                                        <td>{{$rdata->name}}</td>
                        ...
                        <div class="tab-pane fade bgactive" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                            <table id="list-table2" class="table table-striped table-bordered table-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a class="btn btn-outline-danger btn-block" style=" text-align: left;" href="{{url('/acdeo/getpermissiondetails')}}/{{encrypt($adata->permission_id)}}">
                                                @if(!empty($adata->reference_id))
                                                {{$adata->reference_id}}<i class="fa fa-edit float-right font-size01"></i>
                                                @else
                                                {{$adata->permission_id}}<i class="fa fa-edit float-right font-size01"></i>
                                                @endif
                                            </a>
                                        </td>
                                        <td>{{$adata->name}}</td>
                        ...
                        <div class="tab-pane fade bgactive" id="pills-pending" role="tabpanel" aria-labelledby="pills-contact-tab">
                            <table id="list-table3" class="table table-striped table-bordered table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Reference ID</th>
                                        <th>User Name</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a class="btn btn-outline-danger btn-block" style=" text-align: left;" href="{{url('/acdeo/getpermissiondetails')}}/{{encrypt($pdata->permission_id)}}">
                                                @if(!empty($pdata->reference_id))
                                                {{$pdata->reference_id}}<i class="fa fa-edit float-right font-size01"></i>
                                                @else
                                                {{$pdata->permission_id}}<i class="fa fa-edit float-right font-size01"></i>
                                                @endif
                                            </a>
                                        </td>
                                        <td>{{$pdata->name}}</td>

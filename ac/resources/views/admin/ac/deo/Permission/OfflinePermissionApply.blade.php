                ...
                <div class="col-lg-12 p-0">
                    <div class="card">
                        ...
                        <div class="card-body tabular-pane">
                            <form class="form-horizontal" id="permission" method="post" action="{{url('/acdeo/UserDetails')}}" enctype="multipart/form-data" autocomplete="off" onsubmit="return checkForm(this);">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col">
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" name="user_mb" class="form-control" placeholder="Enter Mobile Number" id="mobileno" value="{{old('user_mb')}}" required pattern="[6789][0-9]{9}">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group row">
                                                    <label class="col-sm-4 form-control-label">Select Political Party/Independent<sup>*</sup></label>
                                                    <div class="col-sm-8">
                                            ...
                                            <div class="col">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" name="user_name" class="form-control" placeholder="Enter Name" id="name" value="{{old('user_name')}}" required>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group row">
                                                    <label class="col-sm-4 form-control-label">Email ID<sup>*</sup> <!-- <sup>*</sup> --></label>
                                                    <div class="col-sm-8">
                                                        <input type="text" name="user_email" class="form-control" placeholder="Enter Email ID" id="email" value="{{old('user_email')}}" required pattern="[^@\s]+@[^@\s]+\.[^@\s]+">
                                            ...
                                            <div class="col">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text"  name="fathers_name" value="{{old('fathers_name')}}" class="form-control" placeholder="Enter Father's Name/ Mother's Name/ Husband's Name" id="fathers_name" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input name="dob" type="text" class="form-control" placeholder="Date &amp; time" id='dob' value="{{old('dob')}}" required>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select name="permission_type" class="form-control" id="selectprmsn" required>
                                       ...
                                       <!-- <div class="row">
                                             <div class="col" id="acno">
                                                 <div class="form-group row" >
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select name="ac_no[]" class="form-control" id="ac" multiple>
                                         ...
                                         <div class="row">
                                              <div class="col" >
                                                <div class="form-group row" id="psno">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select name="police_station[]" class="form-control" id="ps" multiple>
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="col">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <textarea cols="40" rows="5" name="address" id="user_address" required>{{old('address')}}</textarea>
                                            ...
                                            <div class="col">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input name="subdate" type="text" id="subdate" class="form-control" placeholder="Date &amp; time" value="{{old('stdate')}}" required>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input name="stdate" type="text" id="startdate" class="form-control" id="datetimepicker" placeholder="Date &amp; time" value="{{old('stdate')}}" required>
                                            ...
                                            <div class="col">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input name="enddate" type="text" id="enddate" class="form-control" id="datetimepicker1" placeholder="Date &amp; time" value="{{old('enddate')}}" required>
...
//        $("#mobileno").blur(function () {
            ...
            {
                $.ajax({
                    url: base_url + '/acdeo/getUserDetails',
                    type: 'POST',
...
//                       $("#ac").css('display','none');
     ...
     $('select#ac').change(function () {
            ...
            $.ajax({
                url: base_url + '/acdeo/getlocation',
                type: 'POST',
...
//                $.ajax({
//                url: base_url + '/acdeo/getalldistrict',
//                type: 'POST',
...
//                });
            ...
            //alert(permsn_id);
            $.ajax({
                url: base_url + '/acdeo/offlinePermission',
                type: 'POST',
...
//                        var j=1;
                        ...
                        var file_name = response[i]['file_name']
                         var fileserver = response[i]['fileserver_dir']; 
                          if(response[i]['authority_type_id'] != undefined && response[i]['authority_type_id'] != null )
                        {
...
//                            str += "<p>" + doc_name + " <small class='text-danger float-right'>" + required_status + "</small></p><br /><div class='custom-file browsebtn  mb-3'><input type='file' class='custom-file-input' id='customFile' name='permsndoc[" + i + "][p_doc]'><label class='custom-file-label' for='customFile'>Choose file</label></div>";
             if(response!=0 && authdata != undefined && authdata != '' && authdata != null)
                        {  
    ...
    if(status == 1)  
                 {
                     ...
                     {
                        str +="<tr><td>"+j+"</td><td><p>"+ doc_name +" <span class='text-alert'> <a href='{{asset('uploads/permission-document')}}/"+stcode+"/"+file_name+" ' download>Download Format</a></span></p></td>";
                        str +="<td><input type='hidden' name='doc["+i+"][doc_id]' value='"+doc_id+"'><input type='file' id='file' name='permsndoc["+i+"][p_doc]' required></td><td><span class='text-alert'>"+ required_status +"</span></td</tr>";
                    }
                    else
                    {
                        str +="<tr><td>"+j+"</td><td><p>"+ doc_name +" <span class='text-alert'> <a href='{{asset('/')}}/"+file_name+" ' download>Download Format</a></span></p></td>";
                        str +="<td><input type='hidden' name='doc["+i+"][doc_id]' value='"+doc_id+"'><input type='file' id='file' name='permsndoc["+i+"][p_doc]' required></td><td><span class='text-alert'>"+ required_status +"</span></td</tr>";
                    }  
    }
                    else
                    {
                     ...
                     {
                        str +="<tr><td>"+j+"</td><td><p>"+ doc_name +" <span class='text-alert'> <a href='{{asset('uploads/permission-document')}}/"+stcode+"/"+file_name+" ' download>Download Format</a></span></p></td>";
                        str +="<td><input type='hidden' name='doc["+i+"][doc_id]' value='"+doc_id+"'><input type='file' id='file' name='permsndoc["+i+"][p_doc]'></td><td><span class='text-alert'>"+ required_status +"</span></td</tr>";
                    }
                    else
                    {
                        str +="<tr><td>"+j+"</td><td><p>"+ doc_name +" <span class='text-alert'> <a href='{{asset('/')}}/"+file_name+" ' download>Download Format</a></span></p></td>";

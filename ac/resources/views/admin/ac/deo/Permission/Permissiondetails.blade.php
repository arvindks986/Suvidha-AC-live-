                    ...
                    <div class="card-body getpermission">
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    @if(!empty($result->required_files) && ($result->required_files != 'NULL' &&
                                    $result->required_files != 'null'))
                                    @php
                                    $docdata=explode(',',$result->required_files);
                                    @endphp
                                    @if(!empty($docdata))
                                    @for($i=0;$i < count($docdata); $i++) @if(!empty($docdata[$i])) @if($result->
                                        fileserver_dir == 'uploads')
                                        <small><a
                                                href="{{asset('uploads/userdoc/permission-document')}}/{{$docdata[$i]}}"
                                                download>Download Document</a></small><br>
                                        @else
                                        <small><a href="{{asset('/')}}{{$docdata[$i]}}" download>Download
                                                Document</a></small><br>
                                        @endif
                                        @endif
                                        @endfor
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <p>{{GetReadableDateForm($result->date_time_start)}} {{'to'}}
                                        {{GetReadableDateForm($result->date_time_end)}}</p>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12 pr-0 pl-0">
                        <div id="new-updates" class="card updates recent-updated">
                            <div id="updates-header"
                                ...
                                <h5><a data-toggle="collapse" data-parent="#new-updates" href="#updates-box"
                                        aria-expanded="true" aria-controls="updates-box" class="">Action Taken By Nodal
                                        Officer</a></h5><a data-toggle="collapse" data-parent="#new-updates"
                                    href="#updates-box" aria-expanded="true" aria-controls="updates-box" class=""><i
                            ...
                            <div id="updates-box" role="tabpanel" class="collapse show" style="">
                                <div class="card-body getpermission ">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <a href="{{asset('uploads/Nodal-Uploaddocument')}}/{{$nodal->permission_request_id}}/{{$nodal->file}}"
                                            class="anchor col-md-4" download>Download Order Copy</a>
                                        @else
                                        <a href="{{asset('/')}}{{$nodal->file}}" class="anchor col-md-4"
                                            download>Download Order Copy</a>
                                        @endif
                                        @else
                                ...
                                <div class="card-footer">
                                    <form class="form-horizontal" id="formid{{$i}}" method="post"
                                        action="{{url('/acdeo/uploadnodaldoc')}}" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="file-select">
                                                        ...
                                                        <input type="hidden" value="{{$nodal->authority_id}}"
                                                            name="auth_id" />
                                                        <input type="hidden" value="{{$nodal->permission_request_id}}"
                                                            name="p_req_id" />
                                                        <input type="file" name="nodal-document"
                                                            id="nodal-document{{$i}}" class="form-control mr-auto"
                                                            accept=".pdf" style="height: 45px !important;" />

                                                        <!--                                                    <div class="file-select-button customchoose" id="fileName">Choose File</div>-->
                                                        <span
                                                            class="text-danger">{{ $errors->error->first('nodal-document') }}</span>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col">
                                                ...
                                                <button type="button" class="btn btn-primary float-right editnodal"
                                                    data-formid='{{$i}}' id='nodaledit{{$i}}' value="Edit"
                                                    name="nodaledit">Edit Data</button>
                                                <button type="button" style="display: none"
                                                    class="btn btn-primary savenodal float-right " id="savenodal{{$i}}"
                                                    name="savenodal" value="Save">Upload</button>
                                            </div>
                                        </div>
                                        @else
                                    @endif
...
<div class="col-lg-12 pr-0 pl-0">
                    <div id="new-updates" class="card updates recent-updated">
                        <div id="updates-header" class="card-header d-flex justify-content-between align-items-center">
                            <h5><a data-toggle="collapse" data-parent="#new-updates" href="#updates-box" aria-expanded="true" aria-controls="updates-box" class="">Action Taken By Applicant</a></h5><a data-toggle="collapse" data-parent="#new-updates" href="#updates-box" aria-expanded="true" aria-controls="updates-box" class=""><i class="fa fa-angle-down"></i></a>
                        </div>

                        <div id="updates-box" role="tabpanel" class="collapse show" style="">
                            <div class="card-body getpermission ">
                                <div class="form-group row">
                                    <label class="col-sm-2">Authority Name</label>
                                    <p class="col-sm-4">Applicant</p>

                                    <label class="col-sm-2">Authority</label>
                                    <p class="col-sm-4">Applicant</p>
                                </div>
                                 <div class="form-group row">
                                    <label class="col-sm-2">Authority Remarks</label>
                                    @if(!empty($candata->comment) && $candata->comment != 'NULL')
                                    <p class="col-sm-4">{{$candata->comment}}</p>
                                    @else
                                    <p class="text-info col-sm-4">No Remarks</p>
                                    @endif
                            ...
                            <div class="card-footer">
                                <form class="form-horizontal" id="formid{{$i}}" method="post" action="{{url('/acdeo/uploadnodaldoc')}}" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    <div id="nodaldoc{{$i}}" style="display: none">
                                        <div class="form-group row">
                                            <label class="col-sm-5 form-control-label">Choose file to Upload</label>
                                            <div class="col-sm-7">
                                                <div class="file-select">
                                                    ...
                                                    <input type="hidden" value="{{$candata->authority_id}}" name="auth_id"/>
                                                    <input type="hidden" value="{{$candata->permission_request_id}}" name="p_req_id"/>
                ...
                @if($result->role_id == '5' )
                    <div class="col-lg-12 pl-0 pr-0">
                        ...
                        <div class="card mb-3">
                            ...
                            <form class="form-horizontal" method="POST" action="{{url('/acdeo/updateaction')}}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="comment" id="" class="form-control" cols="3"
                                                placeholder="Comment here" rows="4" required></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="file-select">
                                                <!--                                            <div class="file-select-name" id="noFile">No file chosen...</div> -->
                                                <input type="file" class="form-control mr-auto" id="customFile"
                                                    name="rofile" accept=".pdf" style="height: 45px !important;"  required />
                                                <!--                                            <div class="file-select-button customchoose" id="fileName">Choose File</div>-->
                                    ...
                                    <div class="form-group row">
                                        <div class="col">
                                            <div class="btn-group float-right">
                                                <button class="btn btn-success float-right text-white" value="Accept"
                                                    name="accept" id="accept">Accept</button>
                                                <button class="btn btn-warning float-right text-white" value="Reject"
                                                    name="reject" id="reject">Reject</button>
                                                <button class="btn btn-danger float-right text-white" value="Cancel"
                    ...
                    <div class="col-lg-12 p-0">
                        ...
                        <div class="form-group row text-center">
                            <div class="col">
                                <button type="submit" class="btn btn-primary btn-lg"><a
                                        href="{{url('/acdeo/generate-pdf')}}/{{$result->permission_id}}{{'&'}}{{$result->location_id}}"

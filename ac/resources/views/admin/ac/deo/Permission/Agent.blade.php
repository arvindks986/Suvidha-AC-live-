                ...
                <div class="col-lg-3" style="text-align: center; margin: 0 auto;">
                    ...
                    <div class="card income text-center">
                        ...
                        <div class="text-success"><b>Agent</b> &nbsp; <div class="btn-group float-right">
                                <a type="button" href="{{url('/acdeo/viewagent')}}"
                                    class="btn btn-sm btn-outline-primary">View</a>
                                <a type="button" href="{{url('/acdeo/agentCreation')}}"
                    ...
                    <div class="sidebar__inner">
                        <div class="card">
                            ...
                            <div class="card-body getpermission">
                                ...
                                <form class="form-horizontal" method="POST" action="{{url('/acdeo/addagent')}}">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" placeholder="Enter Name"
                                                name="uname" value="{{old('uname')}}" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" placeholder="Enter Mobile Number"
                                                name="mb" value="{{old('mb')}}" required pattern="[6789][0-9]{9}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="password" class="form-control" placeholder="Enter Password"
                                                name="pass" value="{{old('pass')}}" required>
                                            <span class="text-danger">{{ $errors->error->first('pass') }}</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 form-control-label">Pin <sup>*</sup></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="pincode" maxlength="6"  id="pin" pattern="^[0-9]{6}$" placeholder="Enter 6 digit PIN" required onkeypress="return mask(this,event);"/>
                                             
                                            <span class="text-danger">{{ $errors->error->first('pincode') }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-footer">
                                        <div class="form-group row">
                                            ...
                                            <div class="col">
                                                <button class="btn btn-success float-right" name="addag"

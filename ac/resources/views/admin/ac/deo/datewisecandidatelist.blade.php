...
<section>
  ...
  <div class="card text-left" style="width:100%; margin:0 auto;">
      ...
      <div class=" row">
            <div class="col"><h4>Candidate List AC Wise</h4></div> 
              <div class="col"><p class="mb-0 text-right"><b>State Name:</b> <span class="badge badge-info">{{$st->ST_NAME}}</span> &nbsp;&nbsp; <b></b>
				<b>District Name:</b> @if(isset($dist) && $dist)
			  <span class="badge badge-info">{{$dist->DIST_NAME}}</span> @endif &nbsp;&nbsp; <b></b>
              <span class="badge badge-info"></span>&nbsp;&nbsp; 
              <a class="btn btn-primary" href="{{ url('/acdeo/reportexcel1/'.base64_encode($date).'/'.base64_encode($ac_no)) }}" title="Download Excel" target="_blank">Export Excel</a>&nbsp;&nbsp;
              <button type="submit" class="btn btn-primary"><a href="{{url('/acdeo/nomination-report')}}"><font color="black">Back</font></a></button>
                 </p>
              </div>
            </div>
      </div>
    ...
    <table   class="table table-striped table-bordered" style="width:100%">
       ...
       if(!empty($candListbyAC)){ ?>
         ...
         <?php
          ...
          $acDetails=getacbyacno($user_data->st_code,$candListbyACData->ac_no);

        ...
        <div class="container-fluid">
            <div class=" row">
               ...
               <!--FILTER STARTS FROM HERE-->
                @if($check_filter =="1")
              <form method="get" action="{{url('/acceo/allscrutiny')}}" id="EcidashboardFilter">           
                        ...
                        <div class="card-body" id="demo" class="collapse show">  
                             <table id="example2" class="display table table-striped" cellspacing="0" width="100%">
                                ...
                                <tr  <?php if (!empty($candDetails->date_of_receipt)) { ?> style="background-color: #999999;cursor: not-allowed;"  <?php } ?>  class="getid" <?php if (empty($candDetails->date_of_receipt)) { ?>  <?php } ?>>
                                    ...
                                    <td>@if(!empty($candDetails->constituency_no)){{ $ac->AC_NO}}-{{ $ac->AC_NAME}} @endif </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('/')}}/acceo/printScrutinyReport/{{base64_encode($candDetails->candidate_id)}}/{{base64_encode($candDetails->constituency_no)}}" class="btn btn-primary btn-sm width-120" target="_blank">Scrutiny Report</a> 
                                        @endif

                                       @if($candDetails->finalized_status=="1")
                                              <a href="{{url('/')}}/acceo/view/{{base64_encode($candDetails->candidate_id)}}/{{base64_encode($candDetails->constituency_no)}}" class="btn btn-secondary btn-sm width-60" >View</a>
                                        @endif
                                    ...
                                    <td>
                                        @if($candDetails->final_by_ceo !='1')
                                         ...
                                         <a href="{{url('/acceo/editExpenditureReport?candidate_id=')}}{{base64_encode($candDetails->candidate_id)}}&ac_no={{base64_encode($candDetails->constituency_no)}}" class="btn btn-primary btn-sm width-140" 
                                           target="_blank">{{!empty($candDetails->final_action)? $candDetails->final_action:'Update Info'}}</a>
...
$(document).ready(function () {
    ...
    $("#button").click(function () {
        ...
        //  var ac_no = $.map(example.rows('.selected').data(), function (item) {
        //     return item;
        // });

    ...
    <div class="card-header pt-3" id="expenditure_section">
        <div class="container-fluid">
            <div class="row text-center pt-2 pb-1">
                <div class="col-sm-12"><h4><b> CEO ELECTION EXPENDITURE MONITORING SYSTEM GENERAL AC ELECTION-2021</b></h4></div>
        ...
        <div class="container-fluid">
          ...
          <div class="row d-flex mb-2">
            <div class="col-lg-3 col-md-4 col-sm-3 mt-5">
              ...
              <div class="card cardNew income reportBox text-center mt-5">
                ...
                <div class="number mb-4 mt-4">
                    <a href="{{url('/')}}/acceo/dataentryStart/{{base64_encode($cons_no)}}" target="" style="font-size: 17px;" class="text-danger">{{ $Percent_startdataentry }} % Data entry started ({{$startdatacount}})</a><br>
                    <a href="{{url('/')}}/acceo/finalizeData/{{ base64_encode($cons_no)}}" target="" style="font-size: 17px;" class="text-info">{{ $Percent_finaldatacount }} % Report Finalised ({{$finaldatacount}})</a>
                </div>
              </div>
            </div>
			 <!--<div class="col-lg-3 col-md-4 col-sm-3 mt-5">
            ...
            <div class="col-lg-3 col-md-4 col-sm-3 mt-5">
              <!-- Income-->
              <div class="card cardNew income reportBox text-center mt-5">
				<a href="{{url('/')}}/acceo/logedaccount/{{ base64_encode($cons_no)}}" target="">
				<div class="feature">
            ...
            <div class="col-lg-3 col-md-4 col-sm-3 mt-5">
              <!-- Income-->
              <div class="card cardNew income reportBox text-center mt-5">
			   <a href="{{url('/')}}/acceo/notintime/{{base64_encode($cons_no)}}" target="">
				<div class="feature">
    ...
    <!-- End of EEMS box Row 1 -->
     <!-- EEMS box Row 2 -->
            <div class="col-lg-3 col-md-4 col-sm-3 mt-5">
              <!-- Income-->
              <div class="card cardNew income reportBox text-center mt-5">
				<a href="{{url('/')}}/acceo/formatedefects/{{base64_encode($cons_no)}}" target="">
				<div class="feature">
            ...
            <div class="col-lg-3 col-md-4 col-sm-3 mt-5">
              <!-- Income-->
              <div class="card cardNew income reportBox text-center mt-5">
				<a href="{{url('/')}}/acceo/understatedexpense/{{base64_encode($cons_no)}}" target="">
				<div class="feature">
    ...
    <!-- End of EEMS box Row 2 -->
     <!-- EEMS box Row 3 -->
            <div class="col-lg-3 col-md-4 col-sm-3 mt-5">
              <!-- Income-->
              <div class="card cardNew income reportBox text-center mt-5">
				<a href="{{url('/')}}/acceo/partyfund/{{base64_encode($cons_no)}}" target="">
				<div class="feature">
            ...
            <div class="col-lg-3 col-md-4 col-sm-3 mt-5">
              <!-- Income-->
              <div class="card cardNew income reportBox text-center mt-5">
				<a href="{{url('/')}}/acceo/othersfund/{{base64_encode($cons_no)}}" target="">
				<div class="feature">

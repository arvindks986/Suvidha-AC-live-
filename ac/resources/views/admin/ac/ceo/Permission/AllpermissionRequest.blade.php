                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-outline-danger btn-block" style=" text-align: left;"
                                                href="{{url('/acceo/getpermissiondetails')}}/{{$data->permission_id}}{{'&'}}{{$data->approved_status}}{{'&'}}{{$data->cancel_status}}{{'&'}}{{$data->location_id}}">
                            ...
                            <table id="list-table1" class="table table-striped table-bordered table-hover"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a class="btn btn-outline-danger btn-block" style=" text-align: left;"
                                                href="{{url('/acceo/getpermissiondetails')}}/{{$rdata->permission_id}}{{'&'}}{{$rdata->approved_status}}{{'&'}}{{$rdata->cancel_status}}{{'&'}}{{$rdata->location_id}}">
                                        ...
                                        <td>
                                            {{$rdata->Approval_name}}
                                            @switch($rdata->Approval_name)
                                                @case('CEO')
                                                <span>(S-{{$rdata->ST_NAME}})</span>
                                                @break
                                                
                                                @case('DEO')
                                                <span>(D-{{$rdata->DIST_NAME}})</span>
                                                @break
                                                
                                                @case('ROAC')
                                                <span>(AC-{{$rdata->AC_NAME}})</span>
                                                @break
                            ...
                            <table id="list-table2" class="table table-striped table-bordered table-hover"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a class="btn btn-outline-danger btn-block" style=" text-align: left;"
                                                href="{{url('/acceo/getpermissiondetails')}}/{{$adata->permission_id}}{{'&'}}{{$adata->approved_status}}{{'&'}}{{$adata->cancel_status}}{{'&'}}{{$adata->location_id}}">
                            ...
                            <table id="list-table3" class="table table-striped table-bordered table-hover"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a class="btn btn-outline-danger btn-block" style=" text-align: left;"
                                                href="{{url('/acceo/getpermissiondetails')}}/{{$pdata->permission_id}}{{'&'}}{{$pdata->approved_status}}{{'&'}}{{$pdata->cancel_status}}{{'&'}}{{$pdata->location_id}}">

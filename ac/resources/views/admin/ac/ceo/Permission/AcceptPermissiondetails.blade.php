                    ...
                    <div id="new-updates" class="card updates recent-updated">
                        <div id="updates-header" class="card-header d-flex justify-content-between align-items-center">
                            <h2 class="h5 display"><a data-toggle="collapse" data-parent="#new-updates"
                                    ...
                                    Taken By Nodal Officer</a></h2><a data-toggle="collapse" data-parent="#new-updates"
...
@endif-->
                ...
                <div class="col-lg-12 pr-0">
                    ...
                    <div id="new-updates" class="card updates recent-updated">
                        <div id="updates-header" class="card-header d-flex justify-content-between align-items-center">
                            <h2 class="h5 display"><a data-toggle="collapse" data-parent="#new-updates"
                                    href="#updates-box" aria-expanded="true" aria-controls="updates-box" class="">Action
                                    Taken By {{$getDetails[0]->Approval_name}}</a></h2><a data-toggle="collapse" data-parent="#new-updates"
                                href="#updates-box" aria-expanded="true" aria-controls="updates-box" class=""><i
                                    class="fa fa-angle-down"></i></a>
                        </div>
                        <div id="updates-box" role="tabpanel" class="collapse show" style="">
                ...
                <div class="col-lg-12 pl-0 pr-0">
                    ...
                    <div class="card mb-3">
                        ...
                        <form class="form-horizontal" method="POST" action="{{url('/acceo/updateaction')}}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="file-select">
                                            ...
                                            <input type="file" class="default-file-input form-control mr-auto"
                                                id="customFile" name="rofile" accept=".pdf"
                    ...
                    <div class="form-group row text-center">
                        <div class="col">
                            <button type="submit" class="btn btn-primary"><a
                                    href="{{url('/acceo/generate-pdf')}}/{{$result->permission_id}}{{'&'}}{{$result->location_id}}"

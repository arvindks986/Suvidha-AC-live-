                        ...
                        <div class="card">
                            ...
                            <div class="card-body getpermission">
                                ...
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-4 form-control-label">Document uploaded by
                                            Applicant</label>
                ...
                <div class="col-lg-6 pr-0">
                    ...
                    <div id="new-updates" class="card updates recent-updated">
                        <div id="updates-header" class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="h5 display"><a data-toggle="collapse" data-parent="#new-updates"
                                    href="#updates-box" aria-expanded="true" aria-controls="updates-box" class="">Action
                                    Taken By Nodal Officer</a></h5><a data-toggle="collapse" data-parent="#new-updates"
...
@endif
                ...
                <div class="col-lg-6 pr-0">
                    ...
                    <div id="new-updates" class="card updates recent-updated">
                        <div id="updates-header" class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="h5 display"><a data-toggle="collapse" data-parent="#new-updates"
                                    href="#updates-box" aria-expanded="true" aria-controls="updates-box" class="">Action
                                    Taken By {{$getDetails[0]->Approval_name}}</a></h5><a data-toggle="collapse" data-parent="#new-updates"
                                href="#updates-box" aria-expanded="true" aria-controls="updates-box" class=""><i
                                    class="fa fa-angle-down"></i></a>
                        </div>
                        ...
                        <div id="updates-box" role="tabpanel" class="collapse show" style="">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <label class="col-sm-5 form-control-label">{{$getDetails[0]->Approval_name}} Comment</label>
                                    <div class="col-sm-7">
                                        <p>{{$RO->comment}}</p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-5 form-control-label">Document Uploded by {{$getDetails[0]->Approval_name}}</label>
                                    @if(!empty($RO->file) && $RO->file != 'NULL')
                                    <div class="col-sm-7">
                                        @if($result->fileserver_dir == 'uploads')
                                        <a href="{{asset('uploads/RO-Uploaddocument')}}/{{$RO->permission_request_id}}/{{$RO->file}}"
                                            download>Download Order Copy</a>
                                        @else
                ...
                <div class="col-lg-12 pl-0 pr-0">
                    ...
                    <div class="card mb-3">
                        ...
                        <form class="form-horizontal" method="POST" action="{{url('/pcceo/updateaction')}}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 form-control-label">Add Comment<span style="color: red;">*</span></label>
                                    <div class="col-sm-8">
                                        <textarea name="comment" id="" class="form-control" cols="3"
                                            placeholder="Comment here" rows="4"></textarea>
                                        <span class="text-danger">{{ $errors->error->first('comment') }}</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 form-control-label">Upload Order<span style="color: red;">*</span></label>
                                    <div class="col-sm-8">
                                        <div class="file-select">
                                            <!--                                            <div class="file-select-name" id="noFile">No file chosen...</div> -->
                                            <input type="file" class="form-control mr-auto" id="customFile"
                                                name="rofile" accept=".pdf" style="height: 45px !important;" />

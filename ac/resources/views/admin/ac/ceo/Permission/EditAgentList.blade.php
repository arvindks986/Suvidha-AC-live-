                    ...
                    <div class="sidebar__inner">
                        <div class="card">
                            ...
                            <div class="card-body getpermission">
                                ...
                                <form class="form-horizontal" method="POST" action="{{url('/acceo/editagent')}}">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" placeholder="Enter Mobile Number"
                                                name="mb" value="{{$data->Phone_no}}" maxlength="10"  minlength="10">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="email" class="form-control" placeholder="Enter Email ID"
                                                name="email" value="{{$data->email}}" pattern="[^@\s]+@[^@\s]+\.[^@\s]+">
                                    ...
                                    <div class="card-footer">
                                        <div class="form-group row">
                                            ...
                                            <div class="col">
                                                <button class="btn btn-success float-right" name="editag"

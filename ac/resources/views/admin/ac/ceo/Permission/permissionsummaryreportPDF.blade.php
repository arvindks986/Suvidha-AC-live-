...
@php 
 $Pending_within_time_total = $Pending_beyond_time_total = $Accepted_total =  $Inprogress_total = $Rejected_total = $total_all = 0;
@endphp
	   ...
	   @foreach($records as $recordvalue)
              <tr>
                ...
                <td>{{ $recordvalue->Pending_within_time}}</td>
                <td>{{ $recordvalue->Pending_beyond_time}}</td>
...
@php 
 $Pending_within_time_total += $recordvalue->Pending_within_time;
 $Pending_beyond_time_total += $recordvalue->Pending_beyond_time;
  $Accepted_total +=  $recordvalue->Accepted;
    $Inprogress_total += $recordvalue->Inprogress;
     $Rejected_total +=  $recordvalue->Rejected;
      $total_all += $recordvalue->total;
@endphp
...
<tr>
                ...
                <td>{{ $Pending_within_time_total}}</td>
                <td>{{ $Pending_beyond_time_total}}</td>
                <td>{{ $Accepted_total}}</td>
                <td>{{ $Inprogress_total}}</td>

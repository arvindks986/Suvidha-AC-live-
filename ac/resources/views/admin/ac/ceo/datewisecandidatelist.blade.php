  ...
  <div class="card text-left" style="width:100%; margin:0 auto;">
      ...
      <div class=" row">
            <div class="col"><h4>Candidate List AC Wise</h4></div> 
              ...
              <a class="btn btn-primary" href="{{ url('/acceo/reportexcelview/'.base64_encode($date).'/'.base64_encode($ac_no)) }}" title="Download Excel" target="_blank">Export Excel</a>&nbsp;&nbsp;
              <button type="submit" class="btn btn-primary"><a href="{{url('/acceo/nomination-report')}}"><font color="black">Back</font></a></button>
                 </p>
              </div>
            </div>
      </div>

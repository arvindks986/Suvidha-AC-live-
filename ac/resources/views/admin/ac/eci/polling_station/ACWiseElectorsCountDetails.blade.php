  ...
  <div class="container-fluid">
    ...
    <form class="row" method="get" action="{{$action}}" id="pswisedataform">
      ...
      <div class="form-group col-md-12">
        <hr/>
      @if($state == null)
      <h4>For fetching AC wise electors details for all states from EROnet <button type="button" class="btn btn-success" onclick="fecthElectors('<?= $fetch_electors_ac ?>')">Click Here</button></h4>
      @elseif(isset($filter_buttons) && count($filter_buttons)>0)
      <h4>For fetching AC wise electors details for @foreach($filter_buttons as $button) <span class="badge badge-success">{{$button}}</span> @endforeach from EROnet <button type="button" class="btn btn-success" onclick="fecthElectors('<?= $fetch_electors_ac ?>')">Click Here</button></h4>
      @endif
      </div>
    </form>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <button type="button" class="btn btn-primary" onclick="fecthElectors('<?= $fetch_electors_ac ?>')">Retry for Failed PS</button>
                    </div>

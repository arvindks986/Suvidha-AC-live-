...
<div class="container-fluid">
  ...
  <div class="col-md-9 pull-left">
   ...
   <div class="col-md-3  pull-right text-right">
      ...
      <a href="{{url('/eci/countnominationfilter_pdf')}}/{{base64_encode($phaseid)}}" class="btn btn-info" role="button" >PDF Download</a> &nbsp;&nbsp;<br></br>
   <!-- <a href="{{url('/eci/countnominationfilter_excel')}}/{{base64_encode($phaseid)}}" class="btn btn-info" role="button">Excel Download</a> &nbsp;&nbsp; -->
  ...
  <br>
    ...
    //dd($tipslastmonth);  
              ...
              <tr>
                ...
                <!-- <td style="text-align: right;"><b>{{$result['phase']}}</b> </td> -->
                <td style="text-align: right;"><b>{{$result['pc_count']}}</b> </td>
                
                  <td style="text-align: right;"><b>{{date('d-m-Y',strtotime($result['LDT_IS_NOM']))}}</b> </td>
...
<!---->
            ...
            <td style="text-align:right">{{$TotalPC}}</td>
             <td></td>

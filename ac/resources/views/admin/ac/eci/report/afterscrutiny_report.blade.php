...
<div class="container-fluid">
  ...
  <div class="col-md-9 pull-left">
   ...
   <div class="col-md-3  pull-right text-right">
      ...
      <a href="{{url('/eci/afterscrutiny_pdf')}}" class="btn btn-info" role="button">PDF Download</a> &nbsp;&nbsp;
   <a href="{{url('/eci/afterscrutiny_excel')}}" class="btn btn-info" role="button">Excel Download</a> &nbsp;&nbsp;

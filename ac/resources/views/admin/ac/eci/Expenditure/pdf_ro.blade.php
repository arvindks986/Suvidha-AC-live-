...
<html lang="en">
    ...
    <body>
        ...
        <p style="text-align: left; font-size: 12pt; background-color: #eaebed; padding: 5px; border: 1px solid #eaebed;"><strong>Name of the State:&nbsp;</strong>{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->ST_NAME:''}}&nbsp;&nbsp;&nbsp;&nbsp;<strong>District:&nbsp;</strong>{{!empty($districtDetails->DIST_NAME)? $districtDetails->DIST_NAME:'N/A'}}&nbsp;&nbsp;&nbsp;<strong>Election:&nbsp;</strong>{{!empty($electionType) ? $electionType : ''}}</p>
...
@if(!empty($scrutinyReportData[0]->rp_act) && $scrutinyReportData[0]->rp_act=="No")
            <tr>

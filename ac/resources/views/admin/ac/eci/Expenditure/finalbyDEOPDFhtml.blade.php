...
<html lang="en">
    ...
    <body>
                ...
                <tr>
                 <td  style="width:50%;">
                    <table  style="width:100%">
                      <tbody>
                         <tr>
                           <td><strong>Candidate List Final By DEO</strong></td>
                         </tr>
                         <tr>  
     ...
     $count = 1; 
		...
		<td>@if(!empty($candDetails->last_date_prescribed_acct_lodge) && strtotime($candDetails->date_orginal_acct)>0) {{ date('d-m-Y',strtotime($candDetails->last_date_prescribed_acct_lodge))}}  @else {{ '22-06-2019'}} @endif</td>

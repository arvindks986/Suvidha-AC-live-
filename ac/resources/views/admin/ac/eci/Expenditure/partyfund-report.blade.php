                ...
                <div class=" row">
                 <div class="col"><h2 class="mr-auto">Fund From Party</h2></div> 
                   <div class="col"><p class="mb-0 text-right">
                        ...
                        <b></b> <a href="{{url('/eci-expenditure/expdashboard')}}"> <button type="button" id="Back" class="btn btn-primary">Back</button></a>									       
                    </p></div>
										</div><!-- end row-->
	              </div><!-- end card-header-->
<div class="card-body">  
...
<tr>
<td>@if(!empty($candDetails->constituency_no )) {{ $candDetails->constituency_no}}-{{ $ac->AC_NAME}} @endif</td>
...
<td>@if(!empty($totalpartyfund))
<a href="{{url('/')}}/eci-expenditure/printScrutinyReport/{{base64_encode($candDetails->candidate_id)}}" class="btn btn-primary btn-sm width-75" target="_blank">Report</a> @else  <span class="btn-secondary text-white btn btn-sm width-110"> Partially Filled</span> 
@endif</td>
</tr>
@endforeach 
@endif 

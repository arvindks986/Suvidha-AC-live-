...
<main role="main" class="inner cover mb-1">     
    <section class="breadcrumb-section">
        <div class="container-fluid">
            <div class=" row">
                <div class="col"><h2 class="mr-auto">Pending At ECI</h2></div> 
...
<table id="list-table" class="table table-striped table-bordered table-hover" style="width:100%">
	...
	<?php $j = 0; ?>
	@if(!empty($getcandidateListpendingatECIReport))
	@foreach($getcandidateListpendingatECIReport as $candDetails)  
	<?php

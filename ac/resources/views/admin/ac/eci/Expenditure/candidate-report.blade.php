    ...
    <section class="breadcrumb-section">
        <div class="container-fluid">
            <div class=" row">
                ...
                <div class="col-md-12 mt-2 mb-2 text-right"><p class="mb-0 text-right">
                        <b>State Name:</b> 
                        ...
                        <b></b>
						<a href="{{url('/')}}/eci-expenditure/definalizedcandidate/{{base64_encode($st_code)}}/{{base64_encode($cons_no)}}"> <button type="button" class="btn btn-primary">Definalized Candidate</button></a>
						<a href="{{url('/')}}/{{$backurl}}"> <button type="button" id="Back" class="btn btn-primary">Back</button></a>
        ...
        <div class="container-fluid">
         <div class="row">
           <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <table id="example11" class="table table-striped table-bordered table-hover" style="width:100%">
        <thead>
        <tr>
          <th>AC No & Name</th>

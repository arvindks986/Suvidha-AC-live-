...
<main role="main" class="inner cover mb-1">     
    <section class="breadcrumb-section">
        <div class="container-fluid">
            <div class=" row">
                <div class="col-md-5 mt-2 mb-2"><h5 class="mr-auto">Candidate List Final By DEO: {{$count}}</h5></div> 
                <div class="col-md-7 mt-2 mb-2 text-right"><p class="mb-0">
                        ...
                        <b></b><a href="{{url('/eci-expenditure/definalize')}}"> <button type="button" id="Back" class="btn btn-primary">Back</button></a>

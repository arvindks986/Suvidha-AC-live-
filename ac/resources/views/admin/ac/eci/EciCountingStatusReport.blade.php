  ...
  <div class="card text-left" style="width:100%; margin:0 auto;">
      ...
      <div class=" row">
            <div class="col"><h4> List Of Counting Status</h4></div> 
              ...
              <span class="badge badge-info"></span>&nbsp;&nbsp; <a href="{{url('/eci/EciCountingStatusReportPdf')}}" class="btn btn-info" role="button">PDF Dwonload</a> &nbsp;&nbsp;
 ...
 <div class="card-body">  
    <table class="table table-striped table-bordered table-hover" style="width:100%">
       ...
       @php  $count++;  @endphp
          ...
          @endforelse
		  <tr><td><b>Total</b></td><td><b></b></td><td><b>{{$TotalAc}}</b></td><td><b>{{$TotalCountingStarted}}</b></td><td><b>{{$TotalDeclared}}</b></td><td><b></b></td></tr>
        </tbody>
    </table>
    </div>
    </div>

                        ...
                        <tbody>
                            @php $counttotal = 0;$countaccept = 0;$countreject = 0;$countinprogress = 0;$countpending = 0;$countcancel = 0; @endphp
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left;">{{$data->ST_NAME}}</td>
                                    <td style="text-align: right;"><a href="{{url('eci/permissiondetails')}}/{{$data->st_code}}/{{$election}}/{{$datefilter}}/{{'6'}}">{{$data->Total}}</a></td>
                                    <td style="text-align: right;"><a href="{{url('eci/permissiondetails')}}/{{$data->st_code}}/{{$election}}/{{$datefilter}}/{{'2'}}">{{$data->Accepted}}</a></td>
                                    <td style="text-align: right;"><a href="{{url('eci/permissiondetails')}}/{{$data->st_code}}/{{$election}}/{{$datefilter}}/{{'3'}}">{{$data->Rejected}}</a></td>
                                    <td style="text-align: right;"><a href="{{url('eci/permissiondetails')}}/{{$data->st_code}}/{{$election}}/{{$datefilter}}/{{'1'}}">{{$data->Inprogress}}</a></td>
                                    <td style="text-align: right;"><a href="{{url('eci/permissiondetails')}}/{{$data->st_code}}/{{$election}}/{{$datefilter}}/{{'0'}}">{{$data->Pending}}</a></td>
                                    <td style="text-align: right;"><a href="{{url('eci/permissiondetails')}}/{{$data->st_code}}/{{$election}}/{{$datefilter}}/{{'5'}}">{{$data->Cancel}}</a></td>
                                </tr>
                                @endforeach
                                @endif
                                <tr>
                                    <td colspan="2"   style="text-align: left;"><span>Grand Total</span></td>
                                    ...
                                    <td  style="text-align: right;"><a href="javascript::void(0)">{{$countcancel}}</a></td>
                                </tr>
                        </tbody>
                    </table>
                </div>

          ...
          <div class="col-lg-3 pr-0">
			...
			<div class="col-lg-3 pr-0">
              ...
              <div class="card income p-0">
               <!--  <div class="icon"><i class="icon-line-chart"></i></div> -->
                <button type="button" style="padding: 18px;" class="btn btn-primary btn-lg btn-block" data-toggle="modal" data-target=".bd-example-modal-xl">Rounds Details  </button>
      ...
      @endif
        ...
        <tbody><?php $j=0;  ?>
            ...
            @foreach($master_data as $md)  
			  ...
			  <td>{{$md->candidate_name}} <br>{{$md->candidate_hname}}<b>Demo</b>   </td>   
	...
	<div class="col">
        ...
        <button type="button" id="evm" class="btn btn-primary getdata" data-toggle="modal" data-target="#evmvote">Edit EVM Votes</button>  
             @if($round_details->scheduled_round==$comp_round and $rid==0)
              ...
              @elseif( $rid==0) 
                  <input type="button" id="submit_form" value="Submit" placeholder="" class="btn btn-success submit-button">
              @else 
                   <input type="button" id="submit_form" value="Update" placeholder="" class="btn btn-success submit-button">
              @endif
             </div>
             </div>
			 </div>

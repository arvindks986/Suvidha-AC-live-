	...
	<?php if($wincan){
        ...
        ?>
         <!--HEADER STARTS HERE-->
			...
			<table align="center" width="100%"> 
				<tbody> 
                                        <tr> <td style="width:100%; font-size:18px;margin:5px 0;" align="justify" >*Election to the Legislative Assembly of <b><u><?php if(isset($ac_state)){ echo $ac_state;}?></u></b> (State/Union territory) from <b><u><?php if(isset($acname)){?>{{$acname}}<?php }?></u></b> Assembly constituency.</td></tr>
			...
			<table align="center" width="100%"> 
				<tbody> 
					<tr> <td style="width:100%; font-size:18px;margin:5px 0;" align="center" ><b><?php if(isset($wincan)){?>{{@$wincan->lead_cand_name}}<?php }?></b> (Name)</td></tr>
                                        <tr> <td style="width:100%; font-size:18px;margin:5px 0;" align="justify" ><b><?php if(isset($wincan)){?>{{ucwords(str_replace(strtolower($dist),'',strtolower($wincan->candidate_residence_address)))}}<?php if(isset($dist)){ echo ', '.$dist;}?><?php if(isset($state)){ echo ', '.$state;}?><?php }?></b> (Address) [sponsored by <b><?php if(isset($wincan)){?>{{@$wincan->lead_cand_party}}<?php }?></b> (name of the recognised/ registered political party)] has been duly elected to fill the vacancy caused in that House by the</td></tr>
                                        <tr align="justify">
                                        ...
                                        <tr align="justify">
                                            <td style="padding-left:450px;">having been declared</td>
					</tr>
				</tbody>
			</table>
        <!--HEADER ENDS HERE-->
...
<table width="100%">
	 ...
	 <tr><td style=" width: 600px;">&nbsp;</td><td>&nbsp;</td><td style="width: 50%;font-size:18px;" align="center"><b>Returning Officer</b></td> <td></td></tr>
         <tr><td style=" width: 600px;">&nbsp;</td><td>&nbsp;</td><td style="width: 25%;font-size:18px;" align="center"><b><?php if(isset($ac_name1)){?>{{@$ac_name1}}<?php }?> Assembly Constituency</b></td> <td></td></tr>
	 </tbody></table>
	 <?php }else{?>

...
<script type="text/javascript" src="{{ asset('public/js/jquery.wordexport.js') }}"></script>
<div class="line"></div>
<section>
              ...
              <div class="card" style="max-width:700px; margin:0 auto;">
                <div class="card-header d-flex align-items-center">
                  <h5>Form 21</h5>
                    ...
                    <div class="card-body">
                    <form id="uploadForm" class="form-horizontal" action="{{url('/roac/booth-counting/form-21-report-upload')}}" method="POST" enctype="multipart/form-data">
					{{ csrf_field() }}
					   ...
					   <div class="col-sm-8">
                        <select name="form_type" id="form_type" class="form-control">
                        	<option value="">Select form type</option>
                                <option value="21c" selected="">Form 21 C</option>
                        	<option value="21d">Form 21 D</option>
                        </select>

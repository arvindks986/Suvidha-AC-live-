...
<div class="container-fluid">
 <div class="row">
     ...
     <div class="col-md-12  pull-right text-right report_section">
         <span class="report-btn" id="export-pdf-btn"><a class="btn btn-primary" href="{{url('/roac/booth-counting/form-21c-report-pdf')}}" title="Download PDF" >Export PDF</a></span>
	...
	<div class="container-fluid">
		...
		<div class="card-body">
			...
			<table width="100%" align="center"> 
				<tbody>
					<tr>
                        <td>*Election to the Legislative Assembly of <b><u><?php if(isset($ac_state)){ echo $ac_state;}?></u></b> (State/Union territory) from <b><u><?php if(isset($acname)){?>{{$acname}}<?php }?></u></b> Assembly constituency.</td>
                    </tr>
					<tr>
			...
			<table width="100%"> 
				<tbody>
					...
					<tr align="justify">
                                        <td><b><?php if(isset($wincan)){?>{{ucwords(str_replace(strtolower($dist),'',strtolower($wincan->candidate_residence_address)))}}<?php if($dist){ echo ', '.$dist;}?><?php if($state){ echo ', '.$state;}?><?php }?></b> (Address) [sponsored by <b><?php if(isset($wincan)){?>{{@$wincan->lead_cand_party}}<?php }?></b> (name of the recognised/ registered political party)] has been duly elected to fill the vacancy caused in that House by the </td>
					</tr>
                                        <tr align="justify">
...
<table width="100%">
	 ...
	 <tr><td style=" width: 100px;">&nbsp;</td><td>&nbsp;</td><td style="width: 50%;font-size:18px;" align="center"><b>Returning Officer</b></td> <td></td></tr>
         <tr><td style=" width: 100px;">&nbsp;</td><td>&nbsp;</td><td style="width: 25%;font-size:18px;" align="center"><b><?php if($user_data){?>{{$ac_name1}}<?php }?> Assembly Constituency</b></td> <td></td></tr>
	 </tbody></table>
		</div>	
		</div>	
		</div>	

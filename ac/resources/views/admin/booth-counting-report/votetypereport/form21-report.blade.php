 ...
 <div class="col-md-9 pull-left">
  <h4>Form 21 E Details</h4>
     ...
     <div class="col-md-3  pull-right text-right report_section">
         <span class="report-btn" id="export-pdf-btn"><a class="btn btn-primary" href="{{url('/roac/booth-counting/form-21-report-pdf')}}" title="Download PDF">Export PDF</a></span>
     </div>
			...
			<table align="center" width="100%"> 
				<tbody>
                                    <tr style="font-size: 18px;">
                                                <td>Election to the Legislative Assembly of <b><u><?php if(isset($state)){ echo $state;}?></u></b> (State/Union territory) from <b><u><?php if(isset($acname)){?>{{$acname}}<?php }?></u></b> Assembly constituency.</td>
					</tr>

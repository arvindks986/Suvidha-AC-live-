...
<script type="text/javascript">
    ...
    $("#state").change(function () {
        ...
        if (state != '') {
            $.ajax({
                url: '<?php echo url('/'); ?>/' + prefix + '/booth-counting/candidate-wise-report-get-ac-state/' + encodeURI(state),
                type: "GET",
                dataType: "html",
...
//                    }
    ...
    $("#acval").change(function () {
        ...
        if (ac != '' && state_code != '') {
            $.ajax({
                url: '<?php echo url('/'); ?>/' + prefix + '/booth-counting/candidate-wise-report-get-party/' + encodeURI(selectedValues) + '/' + encodeURI(state_code),
                type: "GET",
                dataType: "html",
                success: function (msg) {
    ...
    $("#search_record").click(function () {
        ...
        if (state_code != '' && acno != '' && party_id != '') {
            $.ajax({
                type: "POST",
                url: '<?php echo url('/'); ?>/' + prefix + '/booth-counting/candidate-wise-report-ac',
                data: {
                    "_token": "{{ csrf_token() }}",
                    "stateid": state_code,
                    "acno": acno,
    ...
    function DownloadExcel() {
        ...
        var acurl = '<?php echo url('/'); ?>/' + prefix + '/booth-counting/candidate-wise-report-excel';
    ...
    function DownloadPdf() {
        ...
        var acurl = '<?php echo url('/'); ?>/' + prefix + '/booth-counting/candidate-wise-report-pdf';

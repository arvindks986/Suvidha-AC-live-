		  ...
		  <div class="form-group ">
				  ...
				  <div class="animate-help-text profile_img" style="display:<?php echo (!empty($profileimg))?'none':'block';?>">
                    ...
                    <div class="browse_image_outer">
                    	<span  style="font-size: 11px; margin-left: 8px; color: blue;" >Allowed .jpg Format</span>
			...
			<div class="row">
			   <div class="col-sm-6 col-12">
                <div class="form-group mt-2 mb-2 animate-wrap">
				  ...
				  <div class="input-group"  style="width: 250px;">
								  <input type="text" name="epic_no_proposer_serch" id="epic_no_p" class="form-control"  maxlength="20" placeholder="{{ __('step3.enterepic') }}" value="{{$epic_no_proposer_serch}}" />
                      ...
                      <tbody>
						...
						//echo "<pre>"; print_r($iterate_proposer); ?>
                          <tr class="non_recognized_proposers_row">
							...
							<td><input type="number" placeholder="{{ __('step3.sno') }}" class="form-control  particulars-field-12 alphanumeric" name="non_recognized_proposers[{{$key}}][serial_no]" value="{{$iterate_proposer['serial_no']}}" id="s_{{$i}}" ></td>
          ...
          if(json['success'] == false){
           // $('#epic_no').parent('.input-group').after("<span class='text-danger error_message'>"+json['message']+"</span>");
			...
			if("<?php echo Session::get('locale') == 'hi' ?>"){			
				...
				if(json['basic'].fullName != '' && json['basic'].fullName != null){
				   $("#namett").val(json['basic'].fullName);
				}
				if(json['basic'].relativeFullName != '' && json['basic'].relativeFullName != null){
				  $("#father_namett").val(json['basic'].relativeFullName);
				}	
            ...
            if(json['basic'].partSerialNumber != '' && json['basic'].partSerialNumber != null){
              $("#serial_nott").val(json['basic'].partSerialNumber);
            }
			if(json['basic'].partNumber != '' && json['basic'].partNumber != null){
              $("#part_nott").val(json['basic'].partNumber);
            }
			
			
			if(json['basic'].stateCd == '<?php echo $st_code ?>'){            	
				if(json['basic'].acNumber != '' && json['basic'].acNumber != null){ 
				  $('#resident_ac_nott').val(parseInt(json['basic'].acNumber));
	...
	function getDetailsPartOne(){ 
        ...
        success: function(json) { 
          ...
          if(json['success'] == false){ //alert(json['message']);
			...
			if(json['basic'].stateCd == '<?php echo $st_code ?>'){            	
				if(json['basic'].acNumber != '' && json['basic'].acNumber != null){ 
				  $('#resident_ac_no').val(parseInt(json['basic'].acNumber));
            ...
            if(json['basic'].partSerialNumber != '' && json['basic'].partSerialNumber != null){
              $("#serial_no").val(json['basic'].partSerialNumber);
            }
			if(json['basic'].partNumber != '' && json['basic'].partNumber != null){
              $("#part_no").val(json['basic'].partNumber);
            }
        ...
        success: function(json) { 
          ...
          if(json['success'] == false){
           // $('#epic_no').parent('.input-group').after("<span class='text-danger error_message'>"+json['message']+"</span>");
			...
			$(".epic_wrap1").hide();
			if("<?php echo Session::get('locale') == 'hi' ?>"){			
				if(json['basic'].applicantFirstNameL1 != '' && json['basic'].applicantFirstNameL1 != null){
				   $("#proposer_name").val(json['basic'].applicantFirstNameL1);
				}
			
			} else {
				if(json['basic'].fullName != '' && json['basic'].fullName != null){
				   $("#proposer_name").val(json['basic'].fullName);
				}
			}
			...
			if(json['basic'].stateCd === "<?php echo $st_code ?>"){          	
				if(json['basic'].acNumber != '' && json['basic'].acNumber != null){ 
				    if(json['basic'].acNumber == '<?php echo $ac_no ?>'){           
					  $('#proposer_assembly').val(parseInt(json['basic'].acNumber)); 
					  $('#proposer_assembly2').val(parseInt(json['basic'].acNumber)); 
					  $("#sub").prop("disabled", false);
					  $('#state_error').html('');
					  $('#state_error').html("");
					}   else {
            ...
            if(json['basic'].partSerialNumber != '' && json['basic'].partSerialNumber != null){
              $("#proposer_serial_no").val(json['basic'].partSerialNumber);
            }
			if(json['basic'].partNumber != '' && json['basic'].partNumber != null){
              $("#proposer_part_no").val(json['basic'].partNumber);
            }
          }  
          $('.loading_spinner').remove();    
	...
	function getDetailsPartOne_p_both(){ 
        ...
        success: function(json) { 
          ...
          if(json['success'] == false){
			...
			if("<?php echo Session::get('locale') == 'hi' ?>"){			
				if(json['basic'].applicantFirstNameL1 != '' && json['basic'].applicantFirstNameL1 != null){
				   $("#proposer_name_both").val(json['basic'].applicantFirstNameL1);
				}
			
			} else {
				if(json['basic'].fullName != '' && json['basic'].fullName != null){
				   $("#proposer_name_both").val(json['basic'].fullName);
				}
			}
			...
			if(json['basic'].stateCd === "<?php echo $st_code ?>"){          	
				if(json['basic'].acNumber != '' && json['basic'].acNumber != null){ 
				    if(json['basic'].acNumber == '<?php echo $ac_no ?>'){           
					  $('#proposer_assembly_both').val(parseInt(json['basic'].acNumber)); 
					  $('#proposer_assembly2_both').val(parseInt(json['basic'].acNumber)); 
            ...
            if(json['basic'].partSerialNumber != '' && json['basic'].partSerialNumber != null){
              $("#proposer_serial_no_both").val(json['basic'].partSerialNumber);
            }
			if(json['basic'].partNumber != '' && json['basic'].partNumber != null){
              $("#proposer_part_no_both").val(json['basic'].partNumber);
            }
          }  
          $('.loading_spinner').remove();    
        ...
        success: function(json) { 
          ...
          if(json['success'] == false){  
           //$('#epic_no_'+idt).parent('.input-group').after("<span class='text-danger error_message'>"+json['message']+"</span>");
			...
			if(json['basic'].stateCd == '<?php echo $st_code ?>' && json['basic'].acNumber == '<?php echo $ac_no ?>'){       
			
				if("<?php echo Session::get('locale') == 'hi' ?>"){			
					if(json['basic'].applicantFirstNameL1 != '' && json['basic'].applicantFirstNameL1 != null){
						$("#fullname_"+idt).val(json['basic'].applicantFirstNameL1);
					}
				} else {
					if(json['basic'].fullName != '' && json['basic'].fullName != null){
					  $("#fullname_"+idt).val(json['basic'].fullName);
					}
				}
				if(json['basic'].partSerialNumber != '' && json['basic'].partSerialNumber != null){
				  $("#s_"+idt).val(json['basic'].partSerialNumber);
				}
				if(json['basic'].partNumber != '' && json['basic'].partNumber != null){
				  $("#p_"+idt).val(json['basic'].partNumber);
				}
          ...
          if(json['success'] == false){  
           //$('#epic_no_'+idt).parent('.input-group').after("<span class='text-danger error_message'>"+json['message']+"</span>");
			...
			if(json['basic'].stateCd == '<?php echo $st_code ?>' && json['basic'].acNumber == '<?php echo $ac_no ?>'){       
				...
				if("<?php echo Session::get('locale') == 'hi' ?>"){			
					if(json['basic'].applicantFirstNameL1 != '' && json['basic'].applicantFirstNameL1 != null){
						$("#fullname_both_"+idt).val(json['basic'].applicantFirstNameL1);
					}
				} else {
					if(json['basic'].fullName != '' && json['basic'].fullName != null){
					  $("#fullname_both_"+idt).val(json['basic'].fullName);
					}
				}
				if(json['basic'].partSerialNumber != '' && json['basic'].partSerialNumber != null){
				  $("#s_both_"+idt).val(json['basic'].partSerialNumber);
				}
				if(json['basic'].partNumber != '' && json['basic'].partNumber != null){
				  $("#p_both_"+idt).val(json['basic'].partNumber);
				}

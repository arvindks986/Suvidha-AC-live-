     ...
     <section>
	  ...
	  <div class="form-group">
		...
		<div class="col ">
		  ...
		  <div style="background:#007bff;margin-right:50px;color:white;" class="btn btn-primary save_next font-big" ><a style="background:#007bff; color:white;" href="<?php echo url('/'); ?>/dashboard-nomination-new">{{ __('step1.Cancel') }}</a></div>  
		  @if($finalize!='yes')
		  <div style="background:#5342bf;margin-right:50px;" class="btn btn-primary save_next font-big" onclick="return finalize();">{{ __('messages.proSec') }}
		  @else

   ...
   <main class="pt-3 pb-5 pl-5 pr-5">
	 ...
	 <div class="custom-tab-area">	 
	  ...
	  <ul class="nav nav-tabs">
		...
		<!-- 
		<li class="nav-item nav-md-item">
		  <a class="nav-link" href="" class="Affidavit">{{ __('dashboard.tag4') }}</a>
		</li> -->
		...
		<li class="nav-item nav-md-item">
		  <a class="nav-link" data-toggle="tab" href="#adver">{{ __('dashboard.tag3') }}</a>
		</li>
	  </ul>	 
                  ...
                  <div class="col-md-6 col-12 mt-3 mb-5">
					 <div class="tab-actn-btn my-5">
					   <div class="apply-btn my-apped-btn d-inline-flex">
						   <span class="my-apped-icon"></span><a href="{{'nomination/nominations?acs='.$acd.'&std='.$std}}">{{ __('dashboard.my') }}<br/> {{ __('dashboard.tag1') }}</a>

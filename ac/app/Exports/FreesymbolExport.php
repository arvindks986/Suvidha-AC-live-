...
class FreesymbolExport implements FromCollection,WithHeadings, ShouldAutoSize,WithHeadingRow,WithEvents {
    ...
    public function registerEvents(): array {
       ...
       return [
           AfterSheet::class => function(AfterSheet $event) use ($styleArray) {          
            ...
            $event->sheet->getStyle('A1:C1')->getAlignment()->setWrapText(true);        
            ...
            $event->sheet->getStyle('A2:C2')->getAlignment()->setWrapText(true);        
            $event->sheet->getStyle('A2:C2')->getAlignment()->setVertical(\PhpOffice\PhpSpreadsheet\Style\Alignment::VERTICAL_CENTER);

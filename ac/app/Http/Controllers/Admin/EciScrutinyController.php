...
class EciScrutinyController extends Controller {
  ...
  public function get_report_by_state(Request $request){
      ...
      $total_contested      = 0;
      $total_validated      = 0;
      $total_without_affidavit_nomination      = 0;
      ...
      foreach ($data['states'] as $lis) {   
          ...
          $total_without_affidavit_nomination_count    = $this->report_model->get_total_without_nomination(6, $filter_data);
            //dd($count_without_affidavit);
    ...
    $data['totals'] = [
      ...
      'total_without_affidavit_nomination'=>$total_without_affidavit_nomination,
  ...
  public function get_report(Request $request){  
      ...
      $filter_report = array_merge($filter_election,[
        'ac_no'         => ($data['constituency'])?$data['constituency']:NULL,
      ...
      foreach ($lists as $key => $lis) {   
          ...
          $sort['const_name'][$key] = $lis->AC_NAME;
          $sort['const_no'][$key]   = $lis->AC_NO;
          $results[] = [
    ...
    return view('admin.ac.eci.report.date_wise_report', $data);   
  }    
  ...
  public function detail($id,Request $request){
    ...
    //end validate request
     if($id=='withoutaffidavit'){
          $data['heading_title'] = "Scrutiny Report of Without Affidavit Submitted candidate(s)";
     ...
     // dd($lis);
      ...
      if($id=='withoutaffidavit'){
             ...
             $candidates        = $this->report_model->get_nominations_without_affidavit($filter_data);
      }else{
      ...
      foreach ($candidates as $candidate) {
          ...
          $const=$this->commonModel->getacname($candidate->ST_CODE,$candidate->AC_NO);   
          ...
          $results[] = [
            ...
            'pc_no_name'     => $const->AC_NO.'-'.$const->AC_NAME,
    ...
    return view('admin.ac.eci.report.date_wise_report_name', $data);     
  }  
  ...
  public function downlaod_to_excel(Request $request){
    ...
    $export_data[] = ['Constituency Name', 'Total Nominations','Accepted Nominations','Nomination Without Affidavit','Rejected Nominations', 'Withdrawn Nominations','Validately Nominations','Contesting'];
    foreach ($data['results'] as $lis) {
      $export_data[] = [
            'label'              => $lis['label'],
            'total_applied'      => $lis['total_applied'],
            'total_accepted'     => $lis['total_accepted'],
            'total_without_affidavit'    => $lis['total_without_affidavit_nomination'],

...
class MappedLocationController extends Controller {
  ...
  public function mapped_location_report(Request $request){
   ...
   //officer-assignment-report excel function starts
    ...
    $export_data[] = ['State/UT Name','Total PS','Total Location','Mapped Location','Unmapped Location'];
  ...
  //officer-assignment-report-ac function starts
   ...
   //officer-assignment-report-ac excel function starts
    ...
    $export_data[] = ['State/UT Name','CONST No','CONST Name','Total PS','Total Location','Total Mapped','Total Unmapped'];
  ...
  //officer-assignment-report excel function starts
    ...
    $export_data[] = ['S No.','State/UT Name','Const No/Name','PS No/Name'];
    $i=1;
    foreach ($data['results'] as $lis) {
  ...
  //officer-assignment-report excel function starts
    ...
    $export_data[] = ['S No.','State/UT Name','Const No/Name','Location Name'];
    $i=1;
    foreach ($data['results'] as $lis) {

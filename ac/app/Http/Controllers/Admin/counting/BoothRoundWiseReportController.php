...
class BoothRoundWiseReportController extends Controller {
  ...
  public function index(){  
	...
	return view($this->view_path.'.round-wise-report', $data,compact('data', 'state', 'disabled', 'user_type', 'state_id', 'pc_no', 'ac_no', 'get_Pc_data', 'acData', 'condidateData', 'disabledAc', 'condidateDataAc', 'dist_no', 'acDataDeo', 'condidateDeo', 'url'));
  }
	...
	public function getCompleteResult(Request $request){
		...
		if(!isset($input['download'])){ 
			return  view($this->view_path.'.round-wise-report-ajax-result', compact('result', 'st_code', 'state_name', 'ac', 'AC_NAME', 'candidate_name'));
		} else {
			ini_set("pcre.backtrack_limit", "100000");
			$pdf = PDF::loadView($this->view_path.'.round-wise-report-pdf', compact('result', 'st_code', 'LoginData', 'state_name', 'ac', 'AC_NAME', 'candidate_name'));

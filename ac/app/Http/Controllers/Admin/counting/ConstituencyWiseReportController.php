...
public function index(){ 
	...
	$data=array();
	 ...
	 //echo "<pre>"; print_r($get_Pc_data); die;
	 return view($this->view_path.'.constituency-wise-report', $data, compact('data', 'state', 'disabled', 'user_type', 'state_id', 'pc_no', 'ac_no', 'get_Pc_data',  'condidateData', 'disabledAc', 'url'));
  }
	...
	public function getCompleteResult(Request $request){
		...
		if(!isset($input['download'])){
			return  view($this->view_path.'.constituency-wise-report-ajax-result', compact('result', 'stateData', 'result_counting', 'result_type', 'LoginData', 'result_counting_text', 'result_type_text', 'user'));
		} else {
			$pdf = PDF::loadView($this->view_path.'.constituency-wise-report-pdf', compact('result', 'stateData', 'result_counting', 'result_type', 'LoginData', 'result_counting_text', 'result_type_text', 'user', 'state_name'));

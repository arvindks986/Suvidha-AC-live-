...
use DB;
class ACROPermissionModel extends Model 
{ 
    ...
    public function getPermissionDetails($stcode,$distno,$acno)
    {
        //DB::enableQueryLog();
...
//                ->where('a.pc_no',$cond['pc_no'])
    ...
    public function getUserDetails($mb)
    {
        $data=DB::table('user_login as a')
                ...
                ->select('a.*','b.*','c.role_name','a.id as login_id','p.PARTYNAME')
                ->where('a.mobile',$mb)
                ->get()->toArray();
        return $data;
    }
...
//        print_r($where);die;
        $data=DB::table('permission_request as a')
                ...
                ->join('permission_type as d','a.permission_type_id','=','d.id')
                 ->join('permission_master as m','m.id','=','d.permission_type_id')
                ->select('a.*','b.name','c.role_name','a.id as permission_id','b.id as login _id','m.permission_name as pname')

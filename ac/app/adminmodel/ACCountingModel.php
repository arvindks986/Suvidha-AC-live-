...
class ACCountingModel extends Model
    {
     ...
     public function roundsechudle($data = array())
            { 
            $sql_raw = "id,scheduled_round,st_code,ac_no,rejected_votes,postal_total_votes,finalized_ac,added_update_at,tended_votes,tended";
        ...
        public function checkallacfinalize($st_code,$acno,$eleid){

            $r=DB::table('counting_finalized_ac')->where('st_code',$st_code)->where('ac_no',$acno)->where('election_id',$eleid)->where('finalized_ac',0)->first();
        ...
        public function selectsecondhightvalueofcounting($table,$st_code,$acno,$pcno,$contype,$eleid)
            ...
            if($contype=="AC")     
             $result = DB::table($table)
                    ...
                    ->where('ac_no',$acno)->where('election_id',$eleid)->where('party_id','<>','1180')  
                    ->groupBy('id')->groupBy('nom_id')->groupBy('candidate_id')->orderBy('total_vote', 'desc')->limit(1)->offset(1)
                    ->first();  
            elseif($contype=="PC") 
                $result = DB::table($table)
                    ->select([DB::raw('id'),DB::raw('nom_id'),DB::raw('candidate_id'),DB::raw('MAX(total_vote) AS max_total')]) 
                    ->where('ac_no',$pcno)->where('election_id',$eleid)->where('party_id','<>','1180') 
                    ->groupBy('id')->groupBy('nom_id')->groupBy('candidate_id')->orderBy('total_vote', 'desc')->limit(1)->offset(1)
                    ->first();    
                    return $result;
            } 
     public function selectfirsthightvalueofcounting($table,$st_code,$acno,$pcno,$contype,$eleid)
            ...
            if($contype=="AC")       
             ...
             elseif($contype=="PC")
                $result = DB::table($table)
                    ->select([DB::raw('id'),DB::raw('nom_id'),DB::raw('candidate_id'),DB::raw('MAX(total_vote) AS max_total')]) 
                    ->where('PC_NO',$acno)->where('election_id',$eleid)->where('party_id','<>','1180') 
                    ->groupBy('id')->groupBy('nom_id')->groupBy('candidate_id')->orderBy('total_vote', 'desc')
                    ->first(); 
        ...
        public function cantestesting_nomination($st_code,$ac_no,$elec_id)
                {
                  $result = DB::table('candidate_nomination_detail')
                      ->where('st_code',$st_code)->where('ac_no',$ac_no)->where('election_id',$elec_id)->where('application_status','6')
                      ->where('finalize','1')->where('finalaccepted','=','1')->orderBy('new_srno','ASC')->get();
                   return $result;   
                } 
      ...
      public static function evm_votes($table,$id,$nom_id,$data = array()){ 
        	...
        	,0)+IFNULL(round19,0)+IFNULL(round20,0)+IFNULL(round21,0)+IFNULL(round22,0)+IFNULL(round23,0)+IFNULL(round24,0)+IFNULL(round25,0)+IFNULL(round26,0)+IFNULL(round27,0)+IFNULL(round28,0)+IFNULL(round29,0)+IFNULL(round30,0)+IFNULL(round31,0)+IFNULL(round32,0)+IFNULL(round33,0)+IFNULL(round34,0)+IFNULL(round35,0)+IFNULL(round36,0)+IFNULL(
